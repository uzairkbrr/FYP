                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testCases.map((tc, idx) => (
                        <div key={idx} className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-6 flex flex-col hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-shadow duration-300">
                            ...
                            <div>
                                <h3 className="font-semibold text-xl text-gray-900 mb-2 border-b pb-2">Input Voice Note #{idx + 1}</h3>
                                <audio controls src={`/${tc.input_audio.replace(/\\\\/g, '/')}`} className="w-full mb-3 h-10" />
                                <p className="text-base text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-100 mb-4">
                                    {tc.input_roman}
                                </p>
                            </div>

                            <div>
                                <h3 className="font-semibold text-xl text-gray-900 mb-2 border-b pb-2 text-primary">Generated Response</h3>
                                <p className="text-base text-gray-600 bg-blue-50/50 p-3 rounded-lg border border-blue-100 mb-3">
