...
# The TTS model pronounce the capital characters one by one which is written combined. To handle this, we separate the capital characters for better pronunciation;
_PRONUNCIATION_MAP = [
...
# 200,500 => Two lakh, five hundred (for better pronunciation)
...
# Model generating audio from text
def synthesize_speech(text: str) -> str:
    """
    Synthesize text to speech using multilingual model.
